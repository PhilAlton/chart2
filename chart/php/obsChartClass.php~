...
class obsChart{
    ...
    function initTableData($data){
		...
		$this->bldSugarTable->setHighlights(array(2=>BG_RED));
		...
		$this->totalScoreTable->setHighlights(array(2=>BG_RED));
	...
	private function bottomTable(){
		echo '<div class="category" style="height:'.(CELL_HEIGHT*4).'px; padding-bottom:25px;">';
			echo '<table>';
				...
				echo '<td class="cells">';
					echo '<table>';
						$this->addCellRows(array(0,0,0,0));
					echo '</table>';
				echo '</td>';
				echo '<td class="severity">';
					echo '<table>';
